---
title: "Flutter series — Creating the first Flutter application"
date: "2021-06-06"
preview: "Hi Guys. So in our tutorial series now you should have created a spring boot application with an end point to get stock market data for a…"
description: "Creating your first Flutter app to display stock market data from the Spring Boot service built earlier in this series."
tags: ["spring-boot", "flutter"]
mediumUrl: "https://medium.com/@billacode/flutter-series-creating-the-first-flutter-application-793e5816f816"
---
...
![Flutter series — Creating the first Flutter application — figure 1](./images/flutter-series-creating-the-first-flutter-application/1.png)
...
![Here i have specified the web port if not it will run in a random port. So now you will get a chrome browser like this](./images/flutter-series-creating-the-first-flutter-application/2.png)
...
![Now you can see we get the result we needed](./images/flutter-series-creating-the-first-flutter-application/3.png)
