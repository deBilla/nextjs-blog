---
title: "Spring boot series — Stock Market data End Point"
date: "2021-06-04"
preview: "So in my last tutorial, I promised you guys that I will be doing a production deployment of the spring boot application."
description: "Improving the Spring Boot stock market endpoint before deploying to production, with cleaner structure and error handling."
tags: ["spring-boot", "devops"]
mediumUrl: "https://medium.com/@billacode/spring-boot-series-stock-market-data-end-point-356592487254"
---
...
Run this and access [http://localhost:8080/](http://localhost:8080/) you will find the price of a google stock at the moment in the browser.We can modify these methods and do marvelous things. But here i’m showing you only a basic activity we can do.
