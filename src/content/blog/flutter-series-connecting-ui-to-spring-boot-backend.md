---
title: "Flutter series — Connecting UI to spring boot backend"
date: "2021-06-07"
preview: "Hi Guys, So this is the final tutorial of the Stock market app creation tutorials. In future if possible i will try to modify this by…"
description: "Wiring the Flutter stock market UI to its Spring Boot backend endpoint, completing the first working version of the app."
tags: ["spring-boot", "flutter", "realtime"]
mediumUrl: "https://medium.com/@billacode/flutter-series-connecting-ui-to-spring-boot-backend-f9874dc3dcd5"
---
![Flutter series — Connecting UI to spring boot backend — figure 1](./images/flutter-series-connecting-ui-to-spring-boot-backend/1.png)
...
![Flutter series — Connecting UI to spring boot backend — figure 2](./images/flutter-series-connecting-ui-to-spring-boot-backend/2.png)
