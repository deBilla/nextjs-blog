---
title: "Video Encoder for streaming using Node JS, FFMPEG and Bento4 (Javascript Promise to asynchronize)"
date: "2023-09-12"
preview: "Hi Guys, I did my previous tutorial about creating a video encoder for streaming purposes."
description: "A more robust streaming video encoder using Node.js, FFMPEG, and Bento4, with JavaScript promises running the steps asynchronously."
tags: ["nodejs", "video"]
mediumUrl: "https://medium.com/@billacode/writing-a-video-encoder-using-node-js-ffmpeg-and-bento4-a4a04033dfa1"
---
Hi Guys, I did my previous tutorial about creating a video encoder for streaming purposes.
...
![Video Encoder for streaming using Node JS, FFMPEG and Bento4 (Javascript Promise to asynchronize) — figure 1](./images/writing-a-video-encoder-using-node-js-ffmpeg-and-bento4/1.png)
...
For other operating systems, Please go to [https://www.bento4.com/downloads/](https://www.bento4.com/downloads/) and download the zip file and add the path to bento4 bin folder to your Path.
...
Github code: [https://github.com/deBilla/bento-encoder](https://github.com/deBilla/bento-encoder)
