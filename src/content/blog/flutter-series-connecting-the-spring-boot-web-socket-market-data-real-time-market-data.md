---
title: "Flutter series — Connecting the spring boot web socket market data (Real time market data)"
date: "2021-06-11"
preview: "Hi Guys. So in the last tutorial i showed you guys how to create web socket using spring boot application to send market data to front end…"
description: "Connecting a Flutter app to a Spring Boot WebSocket so stock market prices update in real time rather than on a manual refresh."
tags: ["spring-boot", "flutter", "react"]
mediumUrl: "https://medium.com/@billacode/flutter-series-connecting-the-spring-boot-web-socket-market-data-real-time-market-data-976a07022109"
---
![Flutter series — Connecting the spring boot web socket market data (Real time market data) — figure 1](./images/flutter-series-connecting-the-spring-boot-web-socket-market-data-real-time-market-data/1.png)
